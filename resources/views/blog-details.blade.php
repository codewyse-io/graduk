                ...
                <div class="col-lg-8">
                    <div class="blog-details__content">
                        <div class="blog-details__content-thumb">
                            <img src="{{ asset('./assets/imgs/blog/blog-details/blog-details-top-img.png') }}">                        </div>
                    ...
                    <div class="blog-details__middel mt-30 d-flex">
                        <div class="blog-details__middel-img">
                            <img src="{{ asset('./assets/imgs/blog/blog-details/blog-details-middel-img.png') }}">                        </div>
                            ...
                            <div class="sidebar-post__wrapper mt-20">
                                <div class="sidebar-post">
                                    <a href="blog-details" class="sidebar-post_thumb">
                                        <img src="{{ asset('assets/imgs/blog/blog-right-small-img1.png') }}">                                    </a>
                                ...
                                <div class="sidebar-post">
                                    <a href="blog-details" class="sidebar-post_thumb">
                                        <img src="{{ asset('assets/imgs/blog/blog-right-small-img2.png') }}">                                    </a>
                                ...
                                <div class="sidebar-post">
                                    <a href="blog-details" class="sidebar-post_thumb">
                                        <img src="{{ asset('assets/imgs/blog/blog-right-small-img3.png') }}">                                    </a>
