                ...
                <div class="col-lg-8">
                    <div class="coaching-details__content">
                        <div class="coaching-details__content-top-img pb-20" data-tilt>
                            <img src="{{ asset('./assets/imgs/coaching/coaching-details/coaching-details-top-img.png') }}">                        </div>
                    ...
                    <div class="coaching-details__bottom">
                        <div class="coaching-details__bottom-img mb-30" data-tilt>
                            <img src="{{ asset('./assets/imgs/coaching/coaching-details/coaching-details-bottom-img.png') }}">                        </div>
